...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/05 14:21:01 by mmark             #+#    #+#              #
#    Updated: 2019/04/25 16:48:00 by mmark            ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a

SRC_C =	ft_putchar.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c\
		...
		ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_itoa.c ft_putstr.c ft_putendl.c\
		ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c\
		ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c\
		ft_lst_push_back.c ft_lst_size.c ft_lst_last.c ft_lst_fdel.c

SRC_O = $(SRC_C:.c=.o)

.PHONY: all compile lib ran create_lib clean fclean re

all: $(NAME)

$(NAME):
	gcc -Wall -Werror -Wextra -I libft.h -c $(SRC_C)
	ar rc $(NAME) $(SRC_O)
	ranlib $(NAME)
